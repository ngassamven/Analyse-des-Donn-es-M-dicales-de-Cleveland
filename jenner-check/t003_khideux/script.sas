...
/************************************* ANALYSES BIVARIEES *************************************/
/* Test du Khi-Deux d'independance (macro de l'auteur)
   H0 : variables independantes (p > 0,05) ; H1 : variables dependantes (p < 0,05) */
...
TITLE "Test du Khi-Deux d'independance entre la variable &variable_explicative et la variable &variable_interet";
FOOTNOTE "Donnees : Clinique medicale de Cleveland (Etats-Unis)";
RUN;
%MEND;

%KhiDeux(Maladie, Sexe);
%KhiDeux(Maladie, Angine);
