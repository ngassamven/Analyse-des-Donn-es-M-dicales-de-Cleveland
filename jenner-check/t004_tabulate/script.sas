...
/************************************* ANALYSES BIVARIEES *************************************/
/* Tableau croise pour deux variables categorielles (macro de l'auteur) */
%MACRO tableaux_croises(variable_interet, variable_explicative);
PROC TABULATE DATA = donnees;
TITLE "Tableau croise des variables &variable_interet et &variable_explicative (effectifs et pourcentages)";
